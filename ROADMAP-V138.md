# Ih, viajei! — escopo consolidado v138

A v138 preserva os recursos já existentes e acrescenta a conclusão consolidada do novo escopo: Central PRO, Timeline/Hoje na viagem, preparação, conflitos, clima, sugestão de roupas/checklist, acerto de despesas, calendário ICS, PWA/offline, Wallet e Push com ativação condicionada às credenciais oficiais, saúde das integrações e auditoria administrativa.
