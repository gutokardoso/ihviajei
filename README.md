## v143 — Central PRO e operação completa
...
Versão v143 consolidada a partir da base de produção imediatamente anterior, preservando as decisões aprovadas e concluindo as pendências identificadas na auditoria.
...
Admin: 2FA TOTP, audit log e painel de saúde foram conectados. As tabelas v143 são criadas pelo mesmo bootstrap DDL tanto em SQLite quanto em PostgreSQL através do adaptador de produção.
...
## v143 — Administração operacional e acesso de teste
...
## v143 — desempenho e usabilidade da Central PRO
