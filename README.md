## v134 — Central PRO e operação completa
...
Versão v134 consolidada a partir da base de produção imediatamente anterior, preservando as decisões aprovadas e concluindo as pendências identificadas na auditoria.
...
Admin: 2FA TOTP, audit log e painel de saúde foram conectados. As tabelas v134 são criadas pelo mesmo bootstrap DDL tanto em SQLite quanto em PostgreSQL através do adaptador de produção.
...
## v134 — Administração operacional e acesso de teste
