## v142 — Central PRO e operação completa
...
Versão v142 consolidada a partir da base de produção imediatamente anterior, preservando as decisões aprovadas e concluindo as pendências identificadas na auditoria.
...
Admin: 2FA TOTP, audit log e painel de saúde foram conectados. As tabelas v142 são criadas pelo mesmo bootstrap DDL tanto em SQLite quanto em PostgreSQL através do adaptador de produção.
...
## v142 — Administração operacional e acesso de teste
...
## v142 — desempenho e usabilidade da Central PRO
