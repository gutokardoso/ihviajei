# Auditoria de segurança de produção — v133
...
A v133 está mais endurecida para testes com usuários, mas a entrada em produção com pagamentos deve aguardar os itens operacionais acima, especialmente webhook de pagamento assinado/idempotente, MFA administrativo, monitoramento e teste de intrusão.
