# Ih, viajei! — preparação para escala (v140)

## PostgreSQL
A v140 inclui ferramentas para validar a conexão e copiar, de forma transacional e sem apagar a origem, os dados do SQLite para um PostgreSQL provisionado no Railway.
...
## Chaves primárias compostas — estado v140
...
## Backup e restauração PostgreSQL — estado v140
...
## Cutover definitivo de produção — estado v140
