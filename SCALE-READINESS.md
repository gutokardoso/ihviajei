# Ih, viajei! — preparação para escala (v136)

## PostgreSQL
A v136 inclui ferramentas para validar a conexão e copiar, de forma transacional e sem apagar a origem, os dados do SQLite para um PostgreSQL provisionado no Railway.
...
## Chaves primárias compostas — estado v136
...
## Backup e restauração PostgreSQL — estado v136
...
## Cutover definitivo de produção — estado v136
