# Ih, viajei! — preparação para escala (v141)

## PostgreSQL
A v141 inclui ferramentas para validar a conexão e copiar, de forma transacional e sem apagar a origem, os dados do SQLite para um PostgreSQL provisionado no Railway.
...
## Chaves primárias compostas — estado v141
...
## Backup e restauração PostgreSQL — estado v141
...
## Cutover definitivo de produção — estado v141
