# Ih, viajei! — preparação para escala (v139)

## PostgreSQL
A v139 inclui ferramentas para validar a conexão e copiar, de forma transacional e sem apagar a origem, os dados do SQLite para um PostgreSQL provisionado no Railway.
...
## Chaves primárias compostas — estado v139
...
## Backup e restauração PostgreSQL — estado v139
...
## Cutover definitivo de produção — estado v139
