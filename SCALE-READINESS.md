# Ih, viajei! — preparação para escala (v143)

## PostgreSQL
A v143 inclui ferramentas para validar a conexão e copiar, de forma transacional e sem apagar a origem, os dados do SQLite para um PostgreSQL provisionado no Railway.
...
## Chaves primárias compostas — estado v143
...
## Backup e restauração PostgreSQL — estado v143
...
## Cutover definitivo de produção — estado v143
