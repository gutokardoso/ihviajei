# Ih, viajei! — preparação para escala (v137)

## PostgreSQL
A v137 inclui ferramentas para validar a conexão e copiar, de forma transacional e sem apagar a origem, os dados do SQLite para um PostgreSQL provisionado no Railway.
...
## Chaves primárias compostas — estado v137
...
## Backup e restauração PostgreSQL — estado v137
...
## Cutover definitivo de produção — estado v137
