# Ih, viajei! — preparação para escala (v138)

## PostgreSQL
A v138 inclui ferramentas para validar a conexão e copiar, de forma transacional e sem apagar a origem, os dados do SQLite para um PostgreSQL provisionado no Railway.
...
## Chaves primárias compostas — estado v138
...
## Backup e restauração PostgreSQL — estado v138
...
## Cutover definitivo de produção — estado v138
