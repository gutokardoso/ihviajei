# Ih, viajei! — preparação para escala (v135)

## PostgreSQL
A v135 inclui ferramentas para validar a conexão e copiar, de forma transacional e sem apagar a origem, os dados do SQLite para um PostgreSQL provisionado no Railway.
...
## Chaves primárias compostas — estado v135
...
## Backup e restauração PostgreSQL — estado v135
...
## Cutover definitivo de produção — estado v135
