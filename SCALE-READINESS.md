# Ih, viajei! — preparação para escala (v133)

## PostgreSQL
A v133 inclui ferramentas para validar a conexão e copiar, de forma transacional e sem apagar a origem, os dados do SQLite para um PostgreSQL provisionado no Railway.
...
## Chaves primárias compostas — estado v133
...
## Backup e restauração PostgreSQL — estado v133
...
## Cutover definitivo de produção — estado v133
