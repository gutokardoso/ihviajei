# Ih, viajei! — escopo consolidado v135

A v135 preserva os recursos já existentes e acrescenta a conclusão consolidada do novo escopo: Central PRO, Timeline/Hoje na viagem, preparação, conflitos, clima, sugestão de roupas/checklist, acerto de despesas, calendário ICS, PWA/offline, Wallet e Push com ativação condicionada às credenciais oficiais, saúde das integrações e auditoria administrativa.
